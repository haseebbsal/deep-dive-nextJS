    ...
    return (
        <>
            <div  className="flex home-box-shadow flex-col items-center gap-4 border border-2  rounded-xl px-40 py-8">
                ...
                <Link href={'/auth/signup'} className="home-link px-4 py-2 w-full text-center border border-2 rounded hover:!text-black">Sign Up</Link>
                <h1 className=" text-xl ">Already Have An Account?</h1>
                <Link href={'/auth/login'} className="home-link px-4 py-2 w-full text-center border border-2 rounded hover:!text-black ">Log In</Link>
            </div>
            <PreLoader/>
        </>
    )
